...
public class UIKitOptions {
     ...
     */
    public int messageLeftBackground = R.drawable.message_withe_edit_fillet;

    /**
     * IM 发送出去的消息时，内容区域背景的drawable id
     */
    public int messageRightBackground = R.drawable.message_pink_fillet;


    /**
     * IM 发送出去的消息时，内容区域背景的drawable id
     */
    public int messageRightSpecialBackground = R.drawable.message_withe_edit_fillet;
