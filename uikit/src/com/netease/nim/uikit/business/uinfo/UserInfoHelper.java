...
public class UserInfoHelper {
    ...
    public static String getUserDisplayName(String account) {
        ...
        ImUserRespDTO dto = ImUserRespCache.Companion.getInstance().get(account);
     ...
     * 获取用户sign字段
     */
    public static String getSign(String account) {
        UserInfo userInfo = NimUIKit.getUserInfoProvider().getUserInfo(account);
        if (userInfo instanceof NimUserInfo) {
            return ((NimUserInfo) userInfo).getSignature();
        }
        return null;
    }
