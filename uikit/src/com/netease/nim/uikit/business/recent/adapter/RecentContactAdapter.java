...
public class RecentContactAdapter extends BaseMultiItemQuickAdapter<RecentContact, BaseViewHolder> {
    ...
    public RecentContactAdapter(RecyclerView recyclerView, List<RecentContact> data, boolean isPurchaseSupporter) {
        super(recyclerView, data);
        super.isPurchaseSupporter = isPurchaseSupporter;
