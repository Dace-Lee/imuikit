...
//                incomingMsgPrompt.show(lastMsg);
        ...
        if (incomingListener != null) {
            incomingListener.onMessageIncoming();
        }
    }


    private MessageIncomingListener incomingListener;

    public interface MessageIncomingListener {
        void onMessageIncoming();
    }

    public void setMessageIncomingListener(MessageIncomingListener listener) {
    ...
    public void onMessageStatusChange(IMMessage message) {
