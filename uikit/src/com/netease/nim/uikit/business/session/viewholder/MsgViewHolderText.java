...
public class MsgViewHolderText extends MsgViewHolderBase {
    ...
    private void layoutDirection() {
        if (isReceivedMessage()) {
            bodyTextView.setBackgroundResource(R.drawable.message_withe_edit_fillet);
            bodyTextView.setTextColor(context.getResources().getColor(R.color.black_202020));
            bodyTextView.setPadding(ScreenUtil.dip2px(15), ScreenUtil.dip2px(8), ScreenUtil.dip2px(10), ScreenUtil.dip2px(8));
        } else {
            bodyTextView.setBackgroundResource(R.drawable.message_pink_fillet);
            bodyTextView.setTextColor(context.getResources().getColor(R.color.black_202020));
