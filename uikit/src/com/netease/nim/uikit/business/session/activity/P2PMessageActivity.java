...
import com.netease.nim.uikit.common.util.NavigationBarHelper;
...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    private void requestBuddyInfo() {
        ...
        //设置标题栏
        NavigationBarHelper navigationBarHelper = new NavigationBarHelper(this, null);
        navigationBarHelper.setNavLeftGroupToBack();
        navigationBarHelper.mNavRightGroup.setVisibility(View.INVISIBLE);
        navigationBarHelper.mLabelTitle.setText(UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P));
    }
