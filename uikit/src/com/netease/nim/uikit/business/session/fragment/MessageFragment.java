...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    private MessageListPanelEx.MessageIncomingListener incomingListener;

    public void setMessageIncomingListener(MessageListPanelEx.MessageIncomingListener listener) {
    ...
    private void parseIntent() {
        ...
        if (incomingListener != null) {
            messageListPanel.setMessageIncomingListener(incomingListener);
        }

        if (inputPanel == null) {
            boolean isTextAudioSwitchShow = false;
            ImUserRespDTO dto = ImUserRespCache.instance.get(sessionId);
            isTextAudioSwitchShow = dto != null && !dto.getDataMasking();
        ...
        inputPanel.setActivity(getActivity());
...
//                inputPanel.attach_custom_msg_layout.setVisibility(View.GONE);
//            }
//        });
    }
    ...
    public void onInputPanelExpand() {
        ...
        if (inputPanel.attach_custom_msg_layout.getVisibility() == View.VISIBLE) {
            inputPanel.attach_custom_msg_layout.setVisibility(View.GONE);
        }
    }
